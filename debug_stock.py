...
# Change this to the EXACT path of your today's Stock file
file_path = r"C:\project jouba\daily_uploads\cdwstock13082026.csv"
...
try:
    ...
    possible_columns = ['PRODUCER', 'PROD', 'WHOLESALER', 'producer', 'prod', 'wholesaler']
    found = False
